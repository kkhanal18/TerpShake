...
3. Update config/keys.js with your test values for JWT key 
...
3. **Redux.js** state management
3. **Bootstrap** framework 

## Backend

1. **Node.js** with **Express**
2. **REST API** with **MongoDB** database  
3. Login and authentication with **JWT** 
